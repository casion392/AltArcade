...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        //************** NOTE **********
        //Use this ceiling radius deal with a comparison with the other player to determine when to stretch out the hand
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            if(m_Rigidbody2D.velocity.x < m_MaxSpeed && m_Rigidbody2D.velocity.x > -m_MaxSpeed){
                if(move>0){
                    m_Rigidbody2D.AddForce(new Vector2(30f, 0f));
                }
                if (move <0)
                {
                    m_Rigidbody2D.AddForce(new Vector2(-30f, 0f));
